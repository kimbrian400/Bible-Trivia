...
public class computer extends SQLiteOpenHelper {
    ...
    //Here, the database is created with the name computer.db and stored in the Assets folder
    private static final String Database_path = "/data/data/com.kimbrian.bibiletrivia/databases/";
